...
import { VOICE_JOURNEYS, AMBIENTS, type VoiceJourney as VoiceJourneyType, type Ambient } from "@/lib/constants";
...
interface VoiceJourneyProps {
  ...
  withAmbient: boolean;
  onWithAmbientChange: (withAmbient: boolean) => void;
...
VoiceJourney.displayName = "VoiceJourney";
