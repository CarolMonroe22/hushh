                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                    {MOODS.map((mood) => (
                      <button
                        ...
                        className={`p-5 rounded-xl border-2 transition-all duration-300 ease-out text-left focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:outline-none transform hover:scale-[1.02] hover:shadow-lg hover:-translate-y-0.5 ${
                      ...
                      <div className="grid grid-cols-3 gap-2">
                        {AMBIENTS.map((ambient) => (
                          <button
                            ...
                            className={`p-3 rounded-lg border transition-all text-left focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:outline-none transform hover:scale-[1.02] hover:shadow-lg hover:-translate-y-0.5 ${
